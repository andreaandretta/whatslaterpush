...
export default function PaymentPage() {
  ...
  return (
        <div style={{padding: '40px', maxWidth: '500px', margin: '0 auto', fontFamily: 'sans-serif'}}>
                <h1>Attiva SchedWhats Pro</h1>h1>
              <p>Trial scaduto? Nessun problema.</p>p>
              <h2>1.99/mese</h2>h2>
              <ul>
                      <li>Messaggi illimitati</li>li>
                      <li>Supporto prioritario</li>li>
                      <li>Cancellazione quando vuoi</li>li>
              </ul>ul>
